                    ...
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                ...
                                <input id="undefined/non-binary" type="radio" class="@error('gender') is-invalid @enderror" name="gender" value="undefined/non-binary">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <input id="bday" type="date" class="form-control @error('bday') is-invalid @enderror" name="bday" value="{{ old('bday') }}" autocomplete="bday">
